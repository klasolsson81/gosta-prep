...
import { ArrowRight, Linkedin, Globe, Github, FileText, Rocket, Check, Sparkles, X, Loader2, Upload, Radar, Search, User, Zap } from 'lucide-react';
...
import { useGitHubValidation, useLinkedInValidation, useUrlValidation } from '../../hooks/useFieldValidation';
import { PrimaryButton, BackButton, ValidationBadge, validationBorderClass, SummaryBadge } from './OnboardingUI';
